...
type GridEvent struct {
	...
	NominalValue float32 `protobuf:"fixed32,6,opt,name=nominalValue,proto3" json:"nominalValue,omitempty"`     //The measured / estimated value in relation to the event (e.g. in the case of a `VoltageEvent` is the voltage, in the case of a `CurrentEvent` is the current event).
	Percentage   float32 `protobuf:"fixed32,7,opt,name=percentage,proto3" json:"percentage,omitempty"`         //The percentage reached by the value compared to the reference limit or expected value.
	Probability  float32 `protobuf:"fixed32,8,opt,name=probability,proto3" json:"probability,omitempty"`       //The probability that the event actually occurred.
}
...
func (x *GridEvent) GetNominalValue() float32 {
	if x != nil {
...
func (x *GridEvent) GetPercentage() float32 {
	if x != nil {
		return x.Percentage
	}
	return 0
...
func (x *GridEvent) GetProbability() float32 {
	if x != nil {
...
var file_grid_v1_grid_event_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0c, 0x6e, 0x6f, 0x6d, 0x69,
	0x6e, 0x61, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x70, 0x65, 0x72, 0x63,
	0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0a, 0x70, 0x65,
	0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x62,
	0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0b, 0x70,
