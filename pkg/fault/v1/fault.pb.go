...
const (
	...
	PhaseConnectedFaultKind_PHASE_CONNECTED_FAULT_KIND_LINE_OPEN PhaseConnectedFaultKind = 4 // The fault is when the conductor path is broken between two terminals. Additional coexisting faults may be required if the broken conductor also causes connections to grounds or other lines or phases.
)
...
type Fault struct {
	...
	Kind                *PhaseConnectedFaultKind `protobuf:"varint,3,opt,name=kind,proto3,enum=fault.v1.PhaseConnectedFaultKind,oneof" json:"kind,omitempty"` //The kind of phase fault.
	Phases              *PhaseCode               `protobuf:"varint,4,opt,name=phases,proto3,enum=fault.v1.PhaseCode,oneof" json:"phases,omitempty"`           //The phases participating in the fault. The fault connections into these phases are further specified by the type of fault.
	...
	FaultyEquipmentId   *string                  `protobuf:"bytes,6,opt,name=faultyEquipmentId,proto3,oneof" json:"faultyEquipmentId,omitempty"`
	LocationTime        *int64                   `protobuf:"varint,7,opt,name=locationTime,proto3,oneof" json:"locationTime,omitempty"`
	FaulCurrent         *float32                 `protobuf:"fixed32,8,opt,name=faulCurrent,proto3,oneof" json:"faulCurrent,omitempty"`
	Located             *bool                    `protobuf:"varint,9,opt,name=located,proto3,oneof" json:"located,omitempty"`
	ImpactedEquipmentId []string                 `protobuf:"bytes,10,rep,name=impactedEquipmentId,proto3" json:"impactedEquipmentId,omitempty"`
}
...
func (x *Fault) GetImpactedEquipmentId() []string {
	if x != nil {
		return x.ImpactedEquipmentId
	}
	return nil
}
...
var file_proto_fault_v1_fault_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x74, 0x2e, 0x76, 0x31, 0x22, 0x93, 0x04, 0x0a, 0x05, 0x46, 0x61, 0x75, 0x6c, 0x74,
	0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x49, 0x44,
	0x12, 0x25, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x3a, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18,
	...
	,
