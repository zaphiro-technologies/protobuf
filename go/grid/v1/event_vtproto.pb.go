...
func (m *Event) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DetectedAt != nil {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(*m.DetectedAt))
		i--
		dAtA[i] = 0x28
	}
	if m.OccurredAt != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.OccurredAt))
		i--
		dAtA[i] = 0x20
	}
	if m.SourceType != 0 {
...
func (m *Event) SizeVT() (n int) {
	...
	if m.OccurredAt != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.OccurredAt))
	}
	if m.DetectedAt != nil {
		n += 1 + protohelpers.SizeOfVarint(uint64(*m.DetectedAt))
	}
	l = len(m.Message)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
